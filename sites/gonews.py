...
# 設定日誌
logger = logging.getLogger("gonews_crawler")

class Crawler(BaseCrawler):
    """知識網爬蟲，繼承並擴展 BaseCrawler"""
    
    def __init__(self):
        """初始化知識網爬蟲"""
        super().__init__("gonews")
        logger.info("知識網初始化完成")
    ...
    async def extract_article(self, url: str) -> Optional[Dict[str, Any]]:
        ...
        if article:
            ...
            if "content" in article:
                ...
                logger.info(f"知識網處理完成: {url}, 長度: {len(article['content'])}")
